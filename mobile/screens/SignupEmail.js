...
export default function SkinPilotSignup({ navigation }) {
  ...
  const handleSocialSignup = (platform) => {
    if (platform === 'Phone') {
      navigation && navigation.navigate('SignupNumber');
      return;
    }
    if (platform === 'Google'){
            ...
            <View style={styles.signupCard}>
              <View style={styles.signupCardHeader}>
                ...
                >
                  ...
                  <Text style={styles.signupSubtitle}>Enter your details to create an account</Text>
                </LinearGradient>
              </View>
              ...
              <View style={styles.formContainer}>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <View style={[styles.inputWrapper, email.length > 0 && validateEmail(email) && styles.inputValid]}>
                    <TextInput
                    ...
                    {email.length > 0 && (
                      <Feather 
                        name={validateEmail(email) ? "check-circle" : "alert-circle"} 
                        size={20} 
                        color={validateEmail(email) ? "#2196F3" : "#FF3B30"} 
                      />
                    )}
                  </View>
                ...
                <Animated.View style={{ transform: [{ scale: buttonScale }] }}>
                  <TouchableOpacity 
                    style={[styles.signupButton, (!email || !password || !acceptTerms) && styles.signupButtonDisabled]}
                    onPress={handleSignup}
                    activeOpacity={0.8}
                    disabled={!email || !password || !acceptTerms || isSigningUp}
                  >
                    <LinearGradient
                      colors={['#FF3B30', '#2196F3']}
